...
def datapreprocessing(image, label, resize):
    ...
    print("Function draw_label finish!\n")
    
    label = image_to_class_label(label)
    
    print("Function image_to_class_label finish!\n")
    
    label = image_to_1Hlabel(label)
    
    print("Function image_to_1Hlabel finish!\n")
...
#imshow(train_y[1,:,:,0],train_y[10,:,:,0])
