...
def u_net(input_shape):
    ...
    out_layer = Conv2D(filters = num_class, kernel_size = (1,1), activation = "softmax", padding = padding, name ="out")(expansion4.BN2)
...
Sucessfully import smantic_Unet.py!
